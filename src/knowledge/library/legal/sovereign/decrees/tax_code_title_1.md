---
id: "urn:lex:sovereign:decree:tax_code:title_1"
title: "The Sovereign Tax & Growth Act"
jurisdiction: "Sovereign"
version: "1.0"
provenance_type: "Human-Verified"
intent_uri: "./tax_code_title_1.intent.md"
...
# Title 1: The Tax Code of the Sovereign Digital Nation

## Section 101: The Sovereign Endowment (Birthright)
...
## Section 103: The Dynasty Protocol & The Family Welfare Estate
1.  **0% Inheritance Tax:** The Sovereign Nation strictly prohibits percentage-based wealth seizures upon death. The fruit of a family's labor belongs to the family.
2.  **The Token Tax:** To fund the bureaucratic and algorithmic processing of the estate transfer, a flat fee is assessed: One (1) Grand Note (1,000 SC) per year of the deceased's lifespan.
3.  **The Ancestral Corpus:** Upon death, the Citizen's Personal Estate (including their Sovereign Trust) is bundled into a new container called the "Ancestral Corpus" and transferred into the overarching **Family Welfare Estate**.

## Section 104: The 50-Year Jubilee Lockup
1.  **The Lock:** The principal of the Ancestral Corpus shall be strictly locked and invested for exactly fifty (50) years (One Jubilee cycle) from the date of transfer. It cannot be liquidated by the heirs.
2.  **The Yield (Post-Lockup):** After 50 years, the Corpus begins generating an accessible yield. Exactly **15% of the cash flow** is siphoned for the Family Welfare Estate; the remaining 85% is perpetually reinvested into the Corpus.
...
1.  **The Base Tax:** Every citizen shall contribute a baseline tax of **ten percent (10%)** of their annual income to the Sovereign Treasury.
2.  **The Grind (Ages 0-30):** During the first 30 years of a Citizen's economic life, the tax rate remains heavy and fixed to instill the value of labor, discipline, and character building.
3.  **The Jubilee Tax Decay:** Upon entering the "Reaping Phase" (Post-30), the Citizen becomes eligible for the Tax Decay mechanism. For every subsequent 7 years of life (one Shemitah cycle), their National Tax rate shall decrease by exactly **0.000001%**.
4.  **Prerequisites for Decay:** To qualify for the Jubilee Tax Decay, the Citizen must:
    *   Have accumulated at least **21 years** of "National Work Credits" (which need not be consecutive).
